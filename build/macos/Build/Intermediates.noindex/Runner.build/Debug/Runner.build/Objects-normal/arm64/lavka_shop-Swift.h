...
#ifndef LAVKA_SHOP_SWIFT_H
#define LAVKA_SHOP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="lavka_shop",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC10lavka_shop11AppDelegate")
...
SWIFT_CLASS("_TtC10lavka_shop17MainFlutterWindow")
